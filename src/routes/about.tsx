  ...
  return (
    <>
      <PageHero
        ...
        subtitle="From a single workshop on Kundrathur to a city-wide network of certified technicians — we've built our reputation on genuine products, transparent pricing, and obsessive attention to fitment for every car and bike on Chennai roads."
