  ...
  return (
    <section className="relative overflow-hidden bg-foreground py-32 text-background">
      ...
      <div
        ...
        style={{ background: "radial-gradient(closest-side, color-mix(in oklab, var(--electric) 80%, transparent), transparent)" }}
      />
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-electric-glow">Industries</p>
