      ...
      <div className="grid items-center gap-16 lg:grid-cols-2">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            From a single workshop on Kundrathur to a city-wide network of certified technicians —
            we've built our reputation on genuine products, transparent pricing and obsessive
            attention to fitment.
          </p>
          <ul className="mt-8 grid gap-3 text-sm sm:grid-cols-2">
            {[
              "Authorized Multi-Brand",
