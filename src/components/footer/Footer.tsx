        ...
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <div className="mt-6 flex flex-col gap-3 text-sm text-muted-foreground">
              <span className="flex items-center gap-2"><MapPin className="h-4 w-4 text-electric" /> {SITE.address}</span>
              <a href={`tel:${SITE.phone}`} className="flex items-center gap-2 hover:text-foreground"><Phone className="h-4 w-4 text-electric" /> {SITE.phone}</a>
              <a href={`mailto:${SITE.email}`} className="flex items-center gap-2 hover:text-foreground"><Mail className="h-4 w-4 text-electric" /> {SITE.email}</a>
            </div>
          </div>
